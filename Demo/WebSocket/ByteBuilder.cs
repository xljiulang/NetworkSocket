...
namespace NetworkSocket
{
    ...
    public sealed class ByteBuilder
    {
        ...
        /// <param name="value">整数</param>
        /// <param name="littleEndian">是否低位在前</param>
        public void Add(ushort value, bool littleEndian)
        {
            var bytes = ByteConverter.ToBytes(value, littleEndian);
            this.Add(bytes);
        }
        ...
        /// <param name="value">整数</param>
        /// <param name="littleEndian">是否低位在前</param>
        public void Add(uint value, bool littleEndian)
        {
            var bytes = ByteConverter.ToBytes(value, littleEndian);
            this.Add(bytes);
        }
        ...
        /// <param name="value">整数</param>
        /// <param name="littleEndian">是否低位在前</param>
        public void Add(long value, bool littleEndian)
        {
            var bytes = ByteConverter.ToBytes(value, littleEndian);
            this.Add(bytes);
        }
        ...
        /// <param name="value">整数</param>
        /// <param name="littleEndian">是否低位在前</param>
        public void Add(ulong value, bool littleEndian)
        {
            var bytes = ByteConverter.ToBytes(value, littleEndian);
            this.Add(bytes);
        }
        ...
        /// <param name="littleEndian">是否低位在前</param>
        /// <returns></returns>
        public uint ToUInt16(int index, bool littleEndian)
        {
            return ByteConverter.ToUInt16(this.Source, index, littleEndian);
        }
        ...
        {
            return ByteConverter.ToInt32(this.Source, index, littleEndian);
        }
        ...
        /// <param name="littleEndian">是否低位在前</param>
        /// <returns></returns>
        public uint ToUInt32(int index, bool littleEndian)
        {
            return ByteConverter.ToUInt32(this.Source, index, littleEndian);
        }
