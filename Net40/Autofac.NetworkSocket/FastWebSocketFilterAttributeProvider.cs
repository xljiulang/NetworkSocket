...
namespace Autofac.NetworkSocket
{
    ...
    /// Autofac服务行为特性过滤器提供者
    /// </summary>
    internal class FastWebSocketFilterAttributeProvider : FilterAttributeProvider
    {
        /// <summary>
        /// 解析提供者
        /// </summary>
        ...
        public FastWebSocketFilterAttributeProvider(DependencyResolver dependencyResolver)
        {
