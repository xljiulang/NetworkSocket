...
namespace NetworkSocket.Policies
{
    ...
    /// 不可继承
    /// </summary>
    public sealed class SilverlightPolicyServer : TcpServerBase<PolicyPacket, byte[]>
    {
        /// <summary>
        /// 本地943端口
        /// </summary>
        ...
        protected override void OnRecvComplete(IClient<PolicyPacket> client, byte[] rRecv)
        {
